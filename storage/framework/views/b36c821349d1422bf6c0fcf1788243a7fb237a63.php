<header class="site-header">
  <a href="#" class="brand-main">
    <img src="<?php echo e(asset('/assets/admin/img/logo-desk.png')); ?>" id="logo-desk" alt="Laraspace Logo" class="d-none d-md-inline ">
  ...
  <a href="#" class="nav-toggle">
    ...
    <ul class="action-list">
      ...
      <li>
        <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="avatar"><img src="<?php echo e(asset('/assets/admin/img/avatars/avatar.png')); ?>" alt="Avatar"></a>
        <div class="dropdown-menu dropdown-menu-right notification-dropdown">
