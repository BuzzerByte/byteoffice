...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <form id="addPayment" action="<?php echo e(route('payments.add')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($pay->reference_no); ?></td>
                                    <td><?php echo e($pay->payment_method); ?></td>
                                    <td>
                                        <?php echo e($pay->received_amt); ?><?php if($pay->attachment == null || $pay->attachment == ""): ?>
                                        <p style="color:chocolate">No attachment</p>
                                        <?php else: ?>
                                        <a href="/admin/payments/<?php echo e($pay->attachment); ?>"><i class="fa fa-link"
                                                aria-hidden="true"></i></a>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="row">
                                            <input type="text" class="invoice_id" value="<?php echo e($pay->order_id); ?>" hidden>
                                            <?php if(isset(\buzzeroffice\Order::where('id',$pay->order_id)->first()->client_id)): ?>
                                            <input type="text" class="client_id" value="<?php echo e(\buzzeroffice\Order::where('id',$pay->order_id)->first()->client_id); ?>"
                                                hidden>
                                            <?php else: ?>
                                            <?php endif; ?>
                                            <input type="text" class="payment_id" value="<?php echo e($pay->id); ?>" hidden>
                                            <div class="col-sm-4">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($pay->payment_method); ?></td>
                                    <td>
                                        <?php echo e($pay->received_amt); ?>


                                        <?php if($pay->attachment == null || $pay->attachment == ""): ?>
                                        <p style="color:chocolate">No attachment</p>
                                        <?php else: ?>
                                        <a href="/admin/payments/<?php echo e($pay->attachment); ?>"><i class="fa fa-link"
                                                aria-hidden="true"></i></a>
                                    ...
                                    <td>
                                        <div class="row">
                                            <input type="text" class="purchase_id" value="<?php echo e($pay->purchase_id); ?>"
                                                hidden>
                                            <?php if(isset(\buzzeroffice\Purchase::where('id',$pay->purchase_id)->first()->vendor_id)): ?>
                                            <input type="text" class="vendor_id" value="<?php echo e(\buzzeroffice\Purchase::where('id',$pay->purchase_id)->first()->vendor_id); ?>"
                                                hidden>
