...
<div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                            <form action="<?php echo e(route('vendor.import')); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>     
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo e(route('vendor.download')); ?>"><i class="icon-fa icon-fa-arrow-circle-down" aria-hidden="true"></i>
                            Sample CSV File</a>
                    </div>
                </div>
