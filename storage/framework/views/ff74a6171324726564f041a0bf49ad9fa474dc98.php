...
<div class="main-content">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(route('orders.create')); ?>">Create Order</a></li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <?php if (\Entrust::can('invoice-create')) : ?>
                <form action="<?php echo e(route('orders.store')); ?>" id="from-invoice" enctype="multipart/form-data" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-sm-6">
                                            ...
                                            <select class="form-control ls-select2" id="selected_client" name="client_id"  style="width: 100%;"
                                                ...
                                                <?php if($client->id == $selected_client->id): ?>
                                                <option value="<?php echo e($client->id); ?>" selected>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-6">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control inp_email"
                                                    value="<?php echo e($selected_client->email); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control inp_b_address" id="b_address" name="b_address"><?php echo e($selected_client->billing_address); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control inp_s_address" id="s_address" name="s_address"><?php echo e($selected_client->shipping_address); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <td>
                                                    ...
                                                    <select class="inventory new_inventory form-control" style="width: 100%;"
                                                        ...
                                                        <option value="<?php echo e($inventory->id); ?>">
                                                            <?php echo e($inventory->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
