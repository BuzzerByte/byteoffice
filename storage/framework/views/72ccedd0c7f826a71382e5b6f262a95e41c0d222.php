    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-xs-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('users.update',$employee->id )); ?>" id="personalForm"
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="role" disabled="disabled">
                                                ...
                                                <?php if($employee->hasRole($role->name)): ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" value="<?php echo e($employee->f_name); ?>"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="last_name" value="<?php echo e($employee->l_name); ?>"
                                                class="form-control" disabled="disabled" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-group-bottom">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="date_of_birth" type="text" class="form-control ls-datepicker autocomplete_off"
                                                    value="<?php echo e($employee->dob); ?>" data-date-format="yyyy-mm-dd" disabled="disabled" required>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-md" name="marital_status" disabled="disabled">
                                                <?php if($employee->marital_status == 'Single'): ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="blood_group" disabled="disabled">
                                                <option value="<?php echo e($employee->blood_group); ?>" selected><?php echo e($employee->blood_group); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_number" value="<?php echo e($employee->id_number); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="religious" disabled="disabled">
                                        <option value="<?php echo e($employee->religious); ?>" selected><?php echo e($employee->religious); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="/employeesPhoto/<?php echo e($employee->photo); ?>" alt="<?php echo e($employee->photo); ?>"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form action="<?php echo e(route('userAttachments.delete')); ?>" method="post" accept-charset="utf-8">
                                        ...
                                        <tr>
                                            <td>
                                                <label class="css-input css-checkbox css-checkbox-success">
                                                    <input name="personalAttach[]" value="<?php echo e($attachment->id); ?>"
                                                        type="checkbox" class="child_present"><span></span>
                                                </label>
                                            </td>
                                            <td><a href="/employeeAttachments/<?php echo e($attachment->name); ?>"><?php echo e($attachment->name); ?></a></td>
                                            <td><?php echo e($attachment->description); ?></td>

                                            <td><?php echo e(Carbon\Carbon::parse(
                                                $attachment->created_at)->format('d M Y')); ?></td>
                                            <td><?php echo e($attachment->added_by); ?></td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </tbody>
...
<div class="modal fade" id="addAttachmentModal" style="display: none;">
    <?php echo $__env->make('admin.userAttachments.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
