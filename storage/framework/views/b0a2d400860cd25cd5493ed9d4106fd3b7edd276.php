...
<div class="main-content">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(route('users.index')); ?>">Employment Commencement</a></li>
        </ol>
    </div>

    <div class="row">
        <div class="col-md-3">
            <?php echo $__env->make('admin.employees.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
        <div class="col-lg-9 col-md-9 col-xs-9">
            <div class="card">
                ...
                <form action="<?php echo e(route('employeeCommencements.store')); ?>" id="ContactForm" class="ContactForm" method="post"
                    ...
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="joined_date" class="form-control ls-datepicker autocomplete_off"
                                            data-date-format="yyyy-mm-dd" value="<?php echo e($commencement->join_date); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="date_of_permanency" class="form-control ls-datepicker autocomplete_off"
                                            data-date-format="yyyy-mm-dd" value="<?php echo e($commencement->dop); ?>" disabled="disabled"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="probation_end_date" class="form-control ls-datepicker autocomplete_off"
                                            data-date-format="yyyy-mm-dd" value="<?php echo e($commencement->probation_end); ?>"
                                            disabled="disabled" required>
                                    </div>
                                </div>
                        ...
                        <input type="hidden" name="employee_id" value="<?php echo e($commencement->employee_id); ?>" disabled="disabled">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form action="<?php echo e(route('jobHistories.delete')); ?>" method="post" accept-charset="utf-8">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="table-responsive">
                                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php if($jobHistories == null || $jobHistories == ""): ?>
                                            ...
                                            <?php else: ?>
                                            <?php $__currentLoopData = $jobHistories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <label class="css-input css-checkbox css-checkbox-success">
                                                        <input name="jobId[]" value="<?php echo e($job->id); ?>" type="checkbox"
                                                            class="child_present"><span></span>
                                                    </label>
                                                </td>
                                                <td><?php echo e(Carbon\Carbon::parse($job->effective_from)->format('d M
                                                    Y')); ?></td>
                                                <td><?php echo e(\buzzeroffice\Department::where('id',$job->department_id)->first()->name); ?></td>
                                                <td><?php echo e(\buzzeroffice\JobTitle::where('id',$job->title_id)->first()->title); ?></td>
                                                <td><?php echo e(\buzzeroffice\JobCategory::where('id',$job->category_id)->first()->category); ?></td>
                                                <td><?php echo e(\buzzeroffice\WorkShift::where('id',$job->shift_id)->first()->name); ?></td>
                                                <td>
                                                    <a type="button" class="btn btn-success btn-xs"><?php echo e(\buzzeroffice\EmployeeStatus::where('id',$job->status_id)->first()->status); ?></a>
                                                </td>
                                                <td>
                                                    <div class="btn-group mr-2" role="group" aria-label="First group">
                                                        <input type="hidden" class="job_hist" value="<?php echo e($job->id); ?>">
...
<div class="modal fade" id="addNewJobHistory" style="display: none;">
    <?php echo $__env->make('admin.jobHistories.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
<div class="modal fade" id="editJobHistory" style="display: none;">
    <?php echo $__env->make('admin.jobHistories.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
<div class="modal fade" id="addTerminationModal" style="display: none;">
    <?php echo $__env->make('admin.employeeTerminations.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
