...
<div class="main-content">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(route('client.index')); ?>">Attendance</a></li>
        </ol>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                        <form action="<?php echo e(route('profiles.setAttendanceYear',$id)); ?>" class="form-horizontal" method="post"
