            ...
            <div class="modal-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input name="min_salary" class="form-control edit_min autocomplete_off" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input name="max_salary" class="form-control edit_max autocomplete_off" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
